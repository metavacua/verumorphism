...
  (test-entails-duality_l_dualL)
  (test-entails-independence_r_indepR)  ; Added test for indepR
  (test-entails-independence_l_indepL)  ; Added test for indepL
  (test-entails-dependence_r_depR)   ; Added test for depR
  (test-entails-dependence_l_depL)   ; Added test for depL
  (test-entails-provable-duality_r_duality_l) ; Test case for provability using duality rules
  (test-entails-not-provable))
...
;;; --- Run all tests --- ;;;
(run-pattern-match-tests)  ; Keep pattern-match tests running
(run-substitute-bindings-tests)  ; Keep substitute-bindings tests running
(run-entails-tests)  ; Run entails tests